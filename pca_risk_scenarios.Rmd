...
approximationsW <- scenarios["W",]%*%t(factorLoadings[,1:2])+zeroLoading 
approximationsE <- scenarios["E",]%*%t(factorLoadings[,1:2])+zeroLoading 
approximationsN <- scenarios["N",]%*%t(factorLoadings[,1:2])+zeroLoading 
approximationsS <- scenarios["S",]%*%t(factorLoadings[,1:2])+zeroLoading 
